...
On April 11th, 2022 Puppet [announced](https://puppet.com/blog/an-open-letter-from-the-ceo-of-puppet){:target="_blank"} the acquisition from Perforce.
...
In these times where serverless, containers, and cloud based services are trending many people ask me (given my barely concealed addiction for it) what's the future and the role of a tool like Puppet: born to solve problems of the past, when people who had to manage their own servers, rather than relying on some cloud service, a Kubernetes cluster or a bunch of "serverless" functions.

My answer is often on these lines: What's the **average lifetime of the systems** you have to manage? (if you have systems to manage)
...
Whatever the Yaml, HCL, Json files that allow you to describe and configure your IT world, and the tools using them, you need something to put under version control.

You need something that allows you to automate the setups and the configurations you need.

To some degree, the disaster recovery of a modern IT shop is a git repository.

So, back to the key question: what's the lifetime of the systems you have to manage?

**ALL** systems, not only the servers which provide your company's internal or public services (be they on-premise physical and virtual or cloud instances).

If you don't have servers to manage, do you have to install and configure your employees' desktops?
...
It's also one of the hardest to learn, but for this you can rely on people like me.
...
I had just started to work in the national Bank of Italy, as freelance System Administrator, when a colleague came back from some IT conference with infos on this new tool which could help us configuring the hundreds of servers we have to manage.
...
In 2009 I also attended the first PuppetCamp ever, held in San Francisco. It has been a blast. I thought to be a Puppet expert, I found out I had so many things to learn. It has been by far the most useful and enlightening conference I've ever been at.

I've vivid and wonderful memories of that event.

From the visit at Google's headquarters, thanks to Nigel Kersten, who was working there at the times:

![Google First rack](/img/posts/google.png){:height="50%" width="50%"}
...
![San Francisco](/img/posts/sf.png){:height="50%" width="50%"}
...
![PuppetCamp](/img/posts/puppetcamp.png)
...
- [Tiny Puppet](https://github.com/example42/puppet-tp){:target="_blank"}, a single module you can use to install and configure virtually every application on every OS. I like to consider it the most underrated Puppet module ever, but again, I'm biased here.
...
In many of these projects I break many best practice rules and recommendations. I can explain. I've my reasons for each of such controversial choices and I'd do most of them again.
...
It was nice at the times to learn about people and companies using my modules, and curious to see persons surprised to see learn that example42 was just a person and not an organization with various developers.
...
We were both experienced Puppet freelance consultants and we decided to join forces. I wanted to preserve the example42 name, since it was known in Puppet world, Martin had no objections to that.
...
I'm not writing a lot of public code lately, and I'm not happy of that. I wanted to write some updated documentation and hints on Puppet (in the past I wrote a [book on Puppet](https://www.amazon.com/Extending-Puppet-Alessandro-Franceschi-ebook/dp/B00LA414JG){:target="_blank"} which was well received, but now it's definitely obsolete and there's so much to talk about newer Puppet topics and patterns).

The news about the acquisition has left me with a suspended state: I don't know if this will mean the end of Puppet as we know it or the beginning of a new shining era.

At least it has achieved one goal for me: it has enticed me to write this blog post.

Given the times, it might be a beginning.
